 ...
 */
class EvHttp_Controller_Router_Route extends EvHttp_Controller_Router_Route_Abstract
{
    /**
     * Default translator
     *
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            if (isset($name)) {
                if (isset($data[$name]) && !$useDefault) {
                    ...
                    throw new EvHttp_Controller_Router_Exception($name . ' is not specified');
                }
     ...
     * Get the translator
     * 
     * @throws EvHttp_Controller_Router_Exception When no translator can be found
     * @return Zend_Translate
     */
    public function getTranslator()
    {
        ...
        require_once 'EvHttp/Controller/Router/Exception.php';
        throw new EvHttp_Controller_Router_Exception('Could not find a translator');
    }
