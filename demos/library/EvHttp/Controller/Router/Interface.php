 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
interface EvHttp_Controller_Router_Interface
{
    /**
     * Processes a request and sets its controller and action.  If
     * no route was possible, an exception is thrown.
     *
     * @param  EvHttp_Controller_Request_Abstract
     * @throws EvHttp_Controller_Router_Exception
     * @return EvHttp_Controller_Request_Abstract|boolean
     */
    public function route(EvHttp_Controller_Request_Abstract $dispatcher);
