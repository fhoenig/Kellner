 ...
 * @subpackage EvHttp_Controller_Action
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */

/**
 * @see EvHttp_Controller_Action_HelperBroker_PriorityStack
 */
require_once 'EvHttp/Controller/Action/HelperBroker/PriorityStack.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class EvHttp_Controller_Action_HelperBroker
{
    /**
     * $_actionController - ActionController reference
     *
     * @var EvHttp_Controller_Action
     */
     ...
     *
     * @var EvHttp_Controller_Action_HelperBroker_PriorityStack
     */
    ...
    public static function setPluginLoader($loader)
    {
        if ((null !== $loader) && (!$loader instanceof Zend_Loader_PluginLoader_Interface)) {
            ...
            throw new EvHttp_Controller_Action_Exception('Invalid plugin loader provided to HelperBroker');
        }
    ...
    public static function getPluginLoader()
    {
        if (null === self::$_pluginLoader) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'EvHttp_Controller_Action_Helper' => 'EvHttp/Controller/Action/Helper/',
            ));
        }
     ...
     *
     * @param string $path
     * @param string $prefix Optional; defaults to 'EvHttp_Controller_Action_Helper'
     * @return void
     */
    static public function addPath($path, $prefix = 'EvHttp_Controller_Action_Helper')
    {
        self::getPluginLoader()->addPrefixPath($prefix, $path);
    }
     ...
     *
     * @param EvHttp_Controller_Action_Helper_Abstract $helper
     * @return void
     */
    static public function addHelper(EvHttp_Controller_Action_Helper_Abstract $helper)
    {
    ...
    public static function getExistingHelper($name)
    {
        ...
        if (!isset($stack->{$name})) {
            require_once 'EvHttp/Controller/Action/Exception.php';
            throw new EvHttp_Controller_Action_Exception('Action helper "' . $name . '" has not been registered with the helper broker');
        }
     ...
     * Constructor
     *
     * @param EvHttp_Controller_Action $actionController
     * @return void
     */
    public function __construct(EvHttp_Controller_Action $actionController)
    {
     ...
     * @param  array $args
     * @return mixed
     * @throws EvHttp_Controller_Action_Exception if helper does not have a direct() method
     */
    public function __call($method, $args)
    {
        ...
        if (!method_exists($helper, 'direct')) {
            require_once 'EvHttp/Controller/Action/Exception.php';
            throw new EvHttp_Controller_Action_Exception('Helper "' . $method . '" does not support overloading via direct()');
        }
    ...
    protected static function _loadHelper($name)
    {
        try {
            ...
            require_once 'EvHttp/Controller/Action/Exception.php';
            throw new EvHttp_Controller_Action_Exception('Action Helper by name ' . $name . ' not found');
        }

        $helper = new $class();

        if (!$helper instanceof EvHttp_Controller_Action_Helper_Abstract) {
            require_once 'EvHttp/Controller/Action/Exception.php';
            throw new EvHttp_Controller_Action_Exception('Helper name ' . $name . ' -> class ' . $class . ' is not of type EvHttp_Controller_Action_Helper_Abstract');
        }
