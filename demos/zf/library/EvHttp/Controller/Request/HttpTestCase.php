...
/**
 * @see EvHttp_Controller_Request_Http
 */
require_once 'EvHttp/Controller/Request/Http.php';

/**
 * EvHttp_Controller_Request_HttpTestCase
 *
 * HTTP request object for use with EvHttp_Controller family.
 *
 * @uses EvHttp_Controller_Request_Http
 * @package EvHttp_Controller
 * @subpackage Request
 */
class EvHttp_Controller_Request_HttpTestCase extends EvHttp_Controller_Request_Http
{
    /**
     * Request headers
     * @var array
     ...
     * Clear GET values
     * 
     * @return EvHttp_Controller_Request_HttpTestCase
     */
    ...
    public function setMethod($type)
    {
        ...
        if (!in_array($type, $this->_validMethodTypes)) {
            ...
            throw new EvHttp_Controller_Exception('Invalid request method specified');
        }
        $this->_method = $type;
        return $this;
    }
