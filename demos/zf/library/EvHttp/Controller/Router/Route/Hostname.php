 ...
 */
class EvHttp_Controller_Router_Route_Hostname extends EvHttp_Controller_Router_Route_Abstract
{
     ...
     * @return void
     */
    public function setRequest(EvHttp_Controller_Request_Abstract $request = null)
    {
