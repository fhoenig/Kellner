 ...
 *
 * EvHttp_Controller_Action_Helper_ViewRenderer provides transparent view
 ...
 * <code>
 * // In your bootstrap:
 * EvHttp_Controller_Action_HelperBroker::addHelper(new EvHttp_Controller_Action_Helper_ViewRenderer());
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class EvHttp_Controller_Action_Helper_ViewRenderer extends EvHttp_Controller_Action_Helper_Abstract
{
    /**
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
            ...
            throw new EvHttp_Controller_Action_Exception('ViewRenderer cannot locate module directory');
        }
    ...
    public function initView($path = null, $prefix = null, array $options = array())
    {
        ...
        if (empty($path)) {
            ...
            if (empty($path)) {
                 ...
                 */
                require_once 'EvHttp/Controller/Action/Exception.php';
                throw new EvHttp_Controller_Action_Exception('ViewRenderer initialization failed: retrieved view base path is empty');
            }
        }
