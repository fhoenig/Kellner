...
/** EvHttp_Controller_Action_HelperBroker */
require_once 'EvHttp/Controller/Action/HelperBroker.php';

/** EvHttp_Controller_Plugin_Broker */
require_once 'EvHttp/Controller/Plugin/Broker.php';
...
class EvHttp_Controller_Front
{
    ...
    /**
     * Instance of EvHttp_Controller_Dispatcher_Interface
     * @var EvHttp_Controller_Dispatcher_Interface
     */
    ...
    /**
     * Instance of EvHttp_Controller_Plugin_Broker
     * @var EvHttp_Controller_Plugin_Broker
     */
    protected $_plugins = null;

    /**
     * Instance of EvHttp_Controller_Request_Abstract
     * @var EvHttp_Controller_Request_Abstract
     */
    protected $_request = null;

    /**
     * Instance of EvHttp_Controller_Response_Abstract
    ...
    /**
     * Instance of EvHttp_Controller_Router_Interface
     * @var EvHttp_Controller_Router_Interface
     */
    ...
    {
        $this->_plugins = new EvHttp_Controller_Plugin_Broker();
    }
    ...
    public function resetInstance()
    {
        ...
        foreach ($reflection->getProperties() as $property) {
            ...
            switch ($name) {
                ...
                case '_invokeParams':
                    ...
                    break;
                case '_plugins':
                    $this->{$name} = new EvHttp_Controller_Plugin_Broker();
                    break;
        ...
        EvHttp_Controller_Action_HelperBroker::resetHelpers();
    }
     ...
     *
     * @param string|array $controllerDirectory Path to EvHttp_Controller_Action
     * controller classes or array of such paths
     * @return void
     * @throws EvHttp_Controller_Exception if called from an object instance
     */
     ...
     * @return EvHttp_Controller_Front
     * @throws EvHttp_Controller_Exception if directory not found or readable
     */
     ...
     *
     * @param string|array $directory Path to EvHttp_Controller_Action controller
    ...
    public function addModuleDirectory($path)
    {
        try{
            ...
            throw new EvHttp_Controller_Exception("Directory $path not readable");
        }
        foreach ($dir as $file) {
     ...
     *
     * @param string|EvHttp_Controller_Request_Abstract $request
     * @throws EvHttp_Controller_Exception if invalid request class
     * @return EvHttp_Controller_Front
     */
    public function setRequest($request)
    {
        ...
        if (!$request instanceof EvHttp_Controller_Request_Abstract) {
            require_once 'EvHttp/Controller/Exception.php';
            throw new EvHttp_Controller_Exception('Invalid request class');
        }
     ...
     *
     * @return null|EvHttp_Controller_Request_Abstract
     */
     ...
     *
     * @param string|EvHttp_Controller_Router_Interface $router
     * @throws EvHttp_Controller_Exception if invalid router class
     * @return EvHttp_Controller_Front
     */
    public function setRouter($router)
    {
        ...
        if (!$router instanceof EvHttp_Controller_Router_Interface) {
            require_once 'EvHttp/Controller/Exception.php';
            throw new EvHttp_Controller_Exception('Invalid router class');
        }
     ...
     *
     * Instantiates a EvHttp_Controller_Router_Rewrite object if no router currently set.
     *
     * @return EvHttp_Controller_Router_Interface
     */
    public function getRouter()
    {
        if (null == $this->_router) {
            require_once 'EvHttp/Controller/Router/Rewrite.php';
            $this->setRouter(new EvHttp_Controller_Router_Rewrite());
        }
     ...
     * @param string $base
     * @return EvHttp_Controller_Front
     * @throws EvHttp_Controller_Exception for non-string $base
     */
    public function setBaseUrl($base = null)
    {
        if (!is_string($base) && (null !== $base)) {
            require_once 'EvHttp/Controller/Exception.php';
            throw new EvHttp_Controller_Exception('Rewrite base must be a string');
        }
     ...
     * taking a EvHttp_Controller_Dispatcher_Token object, instantiating the controller, and
     * call the action method of the controller.
     *
     * @param EvHttp_Controller_Dispatcher_Interface $dispatcher
     * @return EvHttp_Controller_Front
     */
    public function setDispatcher(EvHttp_Controller_Dispatcher_Interface $dispatcher)
    {
     ...
     *
     * @return EvHttp_Controller_Dispatcher_Interface
     */
    public function getDispatcher()
    {
         ...
         */
        if (!$this->_dispatcher instanceof EvHttp_Controller_Dispatcher_Interface) {
            require_once 'EvHttp/Controller/Dispatcher/Standard.php';
            $this->_dispatcher = new EvHttp_Controller_Dispatcher_Standard();
        }
     ...
     *
     * @param string|EvHttp_Controller_Response_Abstract $response
     * @throws EvHttp_Controller_Exception if invalid response class
     * @return EvHttp_Controller_Front
     */
    public function setResponse($response)
    {
        ...
        if (!$response instanceof EvHttp_Controller_Response_Abstract) {
            require_once 'EvHttp/Controller/Exception.php';
            throw new EvHttp_Controller_Exception('Invalid response class');
        }
     ...
     *
     * @return null|EvHttp_Controller_Response_Abstract
     */
     ...
     * Register a plugin.
     *
     * @param  EvHttp_Controller_Plugin_Abstract $plugin
     * @param  int $stackIndex Optional; stack index for plugin
     * @return EvHttp_Controller_Front
     */
    public function registerPlugin(EvHttp_Controller_Plugin_Abstract $plugin, $stackIndex = null)
    {
     ...
     * Unregister a plugin.
     *
     * @param  string|EvHttp_Controller_Plugin_Abstract $plugin Plugin class or object to unregister
     * @return EvHttp_Controller_Front
     */
     ...
     *
     * @param  string $class
     * @return false|EvHttp_Controller_Plugin_Abstract|array
     */
     ...
     * @return boolean|EvHttp_Controller_Front Used as a setter, returns object; as a getter, returns boolean
     */
