 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class EvHttp_Controller_Router_Route_Regex extends EvHttp_Controller_Router_Route_Abstract
{
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        if ($this->_reverse === null) {
            ...
            throw new EvHttp_Controller_Router_Exception('Cannot assemble. Reversed route is not specified.');
        }
        ...
        if ($return === false) {
            require_once 'EvHttp/Controller/Router/Exception.php';
            throw new EvHttp_Controller_Router_Exception('Cannot assemble. Too few arguments?');
        }
