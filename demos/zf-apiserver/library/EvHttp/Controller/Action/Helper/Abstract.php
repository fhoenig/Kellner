 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class EvHttp_Controller_Action_Helper_Abstract
{
    /**
     * $_actionController
     *
     * @var EvHttp_Controller_Action $_actionController
     */
     ...
     * @return EvHttp_Controller_ActionHelper_Abstract Provides a fluent interface
     */
    public function setActionController(EvHttp_Controller_Action $actionController = null)
    {
