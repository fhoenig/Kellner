 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class EvHttp_Controller_Action_Helper_Redirector extends EvHttp_Controller_Action_Helper_Abstract
{
    /**
     ...
     *
     * @param  int $code
     * @throws EvHttp_Controller_Action_Exception on invalid HTTP status code
     * @return true
     */
    protected function _checkCode($code)
    {
        ...
        if ((300 > $code) || (307 < $code) || (304 == $code) || (306 == $code)) {
            ...
            throw new EvHttp_Controller_Action_Exception('Invalid redirect HTTP status code (' . $code  . ')');
        }
     ...
     *
     * @param  int $code
     * @return EvHttp_Controller_Action_Helper_Redirector Provides a fluent interface
     */
     ...
     * @param  array $args
     * @return mixed
     * @throws EvHttp_Controller_Action_Exception for invalid methods
     */
    public function __call($method, $args)
    {
        ...
        require_once 'EvHttp/Controller/Action/Exception.php';
        throw new EvHttp_Controller_Action_Exception(sprintf('Invalid method "%s" called on redirector', $method));
    }
}
