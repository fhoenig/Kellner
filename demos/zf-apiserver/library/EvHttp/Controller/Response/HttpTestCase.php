...
/**
 * @see EvHttp_Controller_Response_Http
 */
require_once 'EvHttp/Controller/Response/Http.php';

/**
 * EvHttp_Controller_Response_HttpTestCase
 *
 * @uses EvHttp_Controller_Response_Http
 * @package EvHttp_Controller
 * @subpackage Request
 */
class EvHttp_Controller_Response_HttpTestCase extends EvHttp_Controller_Response_Http
{
    /**
