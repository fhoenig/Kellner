 ...
 */
class EvHttp_Controller_Plugin_ErrorHandler extends EvHttp_Controller_Plugin_Abstract
{
    /**
     ...
     *
     * @param  array $options
     * @return EvHttp_Controller_Plugin_ErrorHandler
     */
    ...
    public function getErrorHandlerModule()
    {
        if (null === $this->_errorModule) {
            $this->_errorModule = EvHttp_Controller_Front::getInstance()->getDispatcher()->getDefaultModule();
        }
